...
(function (A, i) {
    ...
    function u(a, b) {
        var b = b === i ? "," : b, c = {}, d = X(a) ? a : a.split(b), e;
        m(d, function (a, b) {
    ...
    function R(a, b, c, d, e) {
        ...
        var f = [], a = a.replace(/([ \t\n\r]*)<(\/)?([\w\-:]+)((?:\s+|(?:\s+[\w\-:]+)|(?:\s+[\w\-:]+=[^\s"'<>]+)|(?:\s+[\w\-:"]+="[^"]*")|(?:\s+[\w\-:"]+='[^']*'))*)(\/)?>([ \t\n\r]*)/g, function (a, n, p, s, wa, M, i) {
            var n = n || "", p = p || "", l = s.toLowerCase(), o = wa || "", s = M ? " " + M : "", i = i || "";
            if (b && !h[l])return"";
            s === "" && ib[l] && (s = " /");
            jb[l] && (n && (n = " "), i && (i = " "));
            Ha[l] && (p ? i = "\n" : n = "\n");
    ...
    function za(a, b) {
        ...
        function f(a, b) {
            ...
            if (j = /#((?:[\w\-]|\\.)+)$/.exec(a))c = e(j[1], k, b); else if (j = /\.((?:[\w\-]|\\.)+)$/.exec(a))c = g(j[1], k, b); else if (j = /\[((?:[\w\-]|\\.)+)\]/.exec(a))c =
                h(j[1].toLowerCase(), null, k, b); else if (j = /\[((?:[\w\-]|\\.)+)\s*=\s*['"]?((?:\\.|[^'"]+)+)['"]?\]/.exec(a)) {
                c = j[1].toLowerCase();
                j = j[2];
        ...
        var s = !1, l, i, o, q, r, w, I, F, t, u;
        w = 0;
        for (lenth = k.length; w < lenth; w++)if (l = k[w], l === ">")s = !0; else {
            if (w > 0) {
                i = [];
                I = 0;
    ...
    function Ma(a, b, c) {
        ...
        function g(e, l) {
            for (var i = e.firstChild, o; i;) {
                ...
                if (m >= 0)return!1;
                o = i.nextSibling;
                if (n > 0)if (i.nodeType == 1)if (p >= 0 && s <= 0)b && l.appendChild(i.cloneNode(!0)), c && f.push(i); else {
                    var M;
                    b && (M = i.cloneNode(!1), l.appendChild(M));
                    if (g(i, M) === !1)return!1
                } else if (i.nodeType == 3 && (i = i == k.startContainer ? d(i, k.startOffset, i.nodeValue.length) :
                    i == k.endContainer ? d(i, 0, k.endOffset) : d(i, 0, i.nodeValue.length), b))try {
                    l.appendChild(i)
                } catch (r) {
                }
                i = o
        ...
        var h = a.doc, f = [], k = a.cloneRange().down(), n = -1, p = -1, s = -1, m = -1, l = a.commonAncestor(), i = h.createDocumentFragment();
    ...
    function qb(a, b) {
        ...
        for (var p = 0, s = g.length; p < s; p++) {
            var i = g[p], k = n.compareEndPoints("StartToStart", d);
            if (k === 0)return{node: i.parentNode, offset: p};
            if (i.nodeType == 1) {
                var l = a.duplicate(), m, o = f(i), r = i;
        ...
        j -= n.text.replace(/\r\n|\n|\r/g, "").length;
        if (k > 0 && h.nodeType ==
            3)for (c = h.previousSibling; c && c.nodeType == 3;)j -= c.nodeValue.length, c = c.previousSibling;
    ...
    function Sa(a) {
        ...
        d.mousedown(function (a) {
            function j(a) {
                a.preventDefault();
                var b = f(S(a.target)), e = P((b.data("pos-x") ||
                    0) + a.pageX - r), a = P((b.data("pos-y") || 0) + a.pageY - q);
            ...
            a.stopPropagation();
            var p = d.get(), i = t(b.css("left")), l = t(b.css("top")), m = b.width(), o = b.height(), r = a.pageX, q = a.pageY;
            e && e();
    ...
    function Za(a) {
        for (var b =
            document.getElementsByTagName("head")[0] || (N ? document.body : document.documentElement), c = document.createElement("link"), d = Db(ha(a, "absolute")), e = f('link[rel="stylesheet"]', b), g = 0, h = e.length; g < h; g++)if (Db(ha(e[g].href, "absolute")) === d)return;
        b.appendChild(c);
        c.href = a;
        c.rel = "stylesheet"
    }
    ...
    if (!A.KindEditor) {
        ...
        var Da = "4.1.6 (2013-03-24)", q = navigator.userAgent.toLowerCase(),
            o = q.indexOf("msie") > -1 && q.indexOf("opera") == -1, da = q.indexOf("gecko") > -1 && q.indexOf("khtml") == -1, V = q.indexOf("applewebkit") > -1, La = q.indexOf("opera") > -1, bc = q.indexOf("mobile") > -1, cc = /ipad|iphone|ipod/.test(q), N = document.compatMode != "CSS1Compat", z = (q = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/.exec(q)) ? q[1] : "0", Ca = (new Date).getTime(), P = Math.round, f = {DEBUG: !1, VERSION: Da, IE: o, GECKO: da, WEBKIT: V, OPERA: La, V: z, TIME: Ca, each: m, isArray: X, isFunction: bb, inArray: L, inString: ta, trim: B, addUnit: r, removeUnit: t, escape: C,
                unescape: ea, toCamel: fa, toHex: ua, toMap: u, toArray: Fa, undef: l, invalidUrl: function (a) {
                    return!a || /[<>"]/.test(a)
        ...
        f.options = {designMode: !0, fullscreenMode: !1, filterMode: !0, wellFormatMode: !0, shadowMode: !0, loadStyleMode: !0, basePath: f.basePath, themesPath: f.basePath + "themes/", langPath: f.basePath + "lang/", pluginsPath: f.basePath + "plugins/", themeType: "default", langType: "zh_CN", urlType: "", newlineTag: "p", resizeType: 2, syncType: "form", pasteType: 2, dialogAlignType: "page",
            useContextmenu: !0, fullscreenShortcut: !1, bodyClass: "ke-content", indentChar: "\t", cssPath: "", cssData: "", minWidth: 680, minHeight: 200, minChangeSize: 50, zIndex: 811213, items: ["source", "|", "undo", "redo", "|", "preview", "print", "template", "code", "cut", "copy", "paste", "plainpaste", "wordpaste", "|", "justifyleft", "justifycenter", "justifyright", "justifyfull", "insertorderedlist", "insertunorderedlist", "indent", "outdent", "subscript", "superscript", "clearhtml", "quickformat", "selectall", "|", "fullscreen", "/", "formatblock",
        ...
        f.ready = function (a) {
            ...
            var e = !1;
            if (document.addEventListener)Z(document, "DOMContentLoaded", b); else if (document.attachEvent) {
        ...
        E(J, {init: function (a) {
            ...
            return(new J(this.doc)).setStart(this.startContainer, this.startOffset).setEnd(this.endContainer,
                this.endOffset)
        }, toString: function () {
            var a = this.get();
        ...
        E(ma, {init: function (a) {
            ...
            var a = l(a, !0), b = this.sel, c = this.range.cloneRange().shrink(), d = c.startContainer, e = c.startOffset, g = S(d), h = this.win, j, k = !1;
            ...
            if (d > 0) {
                ...
                i && ca(i) && (i.remove(), c.setStart(b, d - 1), b == e && c.setEnd(e,
                    n - 1));
            ...
            if (a === "forecolor")return(a = this.commonNode({"*": ".color"})) && (c = a.css("color")), c = ua(c), c === "" && (c = "default"),
                c.toLowerCase();
            if (a === "hilitecolor")return(a = this.commonNode({"*": ".background-color"})) && (c = a.css("background-color")), c = ua(c), c === "" && (c = "default"), c.toLowerCase();
            return c
        }, toggle: function (a, b) {
        ...
        m("formatblock,selectall,justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,indent,outdent,subscript,superscript".split(","), function (a, b) {
            ma.prototype[b] = function (a) {
                this.select();
                O(this.doc, b, a);
                (!o || L(b, "formatblock,selectall,insertorderedlist,insertunorderedlist".split(",")) >=
                    0) && this.selection();
                return this
            }
        });
        ...
        E(oa, Q, {init: function (a) {
            ...
            var d = l(a.themesPath, ""), e = a.bodyClass, g = a.cssPath, h = a.cssData, j = location.host.replace(/:\d+/,
                "") !== document.domain, k = "document.open();" + (j ? 'document.domain="' + document.domain + '";' : "") + "document.close();", k = o ? ' src="javascript:void(function(){' + encodeURIComponent(k) + '}())"' : "";
        ...
        E(pa, Q, {init: function (a) {
            ...
            if (a.title === "-")this.div.append(f('<div class="ke-menu-separator"></div>')); else {
                var b = f('<div class="ke-menu-item" unselectable="on"></div>'),
                    c = f('<div class="ke-inline-block ke-menu-item-left"></div>'), d = f('<div class="ke-inline-block ke-menu-item-right"></div>'), e = r(a.height), g = l(a.iconClass, "");
                this.div.append(b);
        ...
        E(Xa, {init: function (a) {
            ...
            b.bind("load", function () {
                ...
                c.reset();
                f(c).remove(!0);
                var c = f.iframeDoc(b), d = c.getElementsByTagName("pre")[0], e = "", g, e = d ? d.innerHTML : c.body.innerHTML, e = ea(e);
        ...
        sa.prototype = {lang: function (a) {
            ...
            function a() {
                c.isCreated &&
                c.resize(G().clientWidth, G().clientHeight, !1)
            }
            ...
            var e = d ? G().clientWidth + "px" : c.width, g = d ? G().clientHeight + "px" : c.height;
            if (o && z < 8 || N)g = r(t(g) + 2);
            var h = c.container = f(c.layout);
            d ? f(document.body).append(h) : c.srcElement.before(h);
            var j = f(".toolbar", h), k =
                f(".edit", h), i = c.statusbar = f(".statusbar", h);
            ...
            } else c._fullscreenExecuted && (f(document.body).css({height: "", overflow: ""}), f(document.body.parentNode).css("overflow", "")), c._scrollPos &&
                A.scrollTo(c._scrollPos.x, c._scrollPos.y);
            var l = [];
            ...
            var j = c.toolbar = Ab({src: j, html: l.join(""), noDisableItems: c.noDisableItems, click: function (a, b) {
                a.stop();
                if (c.menu) {
                    var d =
                        c.menu.name;
                ...
                c.clickToolbar(b)
            }}), m = t(g) - j.div.height(), q = c.edit = yb({height: m > 0 && t(g) > c.minHeight ? m : c.minHeight, src: k, srcElement: c.srcElement, designMode: c.designMode, themesPath: c.themesPath, bodyClass: c.bodyClass, cssPath: c.cssPath, cssData: c.cssData, beforeGetHtml: function (a) {
                a = c.beforeGetHtml(a);
            ...
            d ? (f(A).bind("resize", a), j.select("fullscreen"), i.first().css("visibility", "hidden"), i.last().css("visibility", "hidden")) : (da && f(A).bind("scroll", function () {
                c._scrollPos =
                    aa()
            }), c.resizeType > 0 ? Sa({moveEl: h, clickEl: i, moveFn: function (a, b, d, e, g, f) {
                e += f;
                c.resize(null, e)
            }}) : i.first().css("visibility", "hidden"), c.resizeType === 2 ? Sa({moveEl: h, clickEl: i.last(), moveFn: function (a, b, d, e, f, g) {
                d += f;
                e += g;
                c.resize(d, e)
            ...
            if (b && (b = t(b), editHeight = t(b) - this.toolbar.div.height() - this.statusbar.height(), editHeight = editHeight < this.minHeight ? this.minHeight : editHeight, this.edit.setHeight(editHeight),
                c))this.height = r(b);
            return this
        }, select: function () {
            ...
            var a = a.toLowerCase(), b = this.cmd, c = L(a, "selectall,copy,paste,print".split(",")) <
                0;
            ...
            focus: function () {
                ...
                b.designMode && !this._firstAddBookmark ? (b = this.cmd.range, a = b.createBookmark(!0), a.html = $a(c.innerHTML), b.moveToBookmark(a)) :
                    a = {html: d};
        ...
        Eb("core", function (a) {
            ...
            b.afterCreate(function () {
                ...
                a(d.body).bind("paste", function (r) {
                    if (b.pasteType === 0)r.stop(); else if (!m) {
                        m = !0;
                        a("div." + l, d).remove();
                        f = b.cmd.selection();
            ...
            b.beforeGetHtml(function (a) {
                ...
                return a.replace(/(<(?:noscript|noscript\s[^>]*)>)([\s\S]*?)(<\/noscript>)/ig,function (a, b, c, d) {
                    return b +
                        ...
                        var a = H(a), b = $(a.style || ""), c = nb(a["data-ke-tag"]);
