...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.default_multiple_text = "可以选择多个选项";

    AbstractChosen.default_single_text = "请选择任一选项";

    AbstractChosen.default_no_result_text = "没有匹配的结果";
...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.winnow_results = function() {
      ...
      results = 0;
      searchText = this.search_field.val() === this.default_text ? "" : $('<div/>').text(this.search_field.val()).html();
