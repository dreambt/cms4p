        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("pattern") !== undefined) {
              message = "格式不正确<!-- data-validation-pattern-message to override -->";
            ...
            if ($this.attr("max") !== undefined || $this.attr("aria-valuemax") !== undefined) {
              ...
              message = "不能大于 '" + max + "'<!-- data-validation-max-message to override -->";
            ...
            if ($this.attr("min") !== undefined || $this.attr("aria-valuemin") !== undefined) {
              ...
              message = "不能小于 '" + min + "'<!-- data-validation-min-message to override -->";
            ...
            if ($this.attr("maxlength") !== undefined) {
              message = "最多 '" + $this.attr("maxlength") + "' 个字符<!-- data-validation-maxlength-message to override -->";
            ...
            if ($this.attr("minlength") !== undefined) {
              message = "最少 '" + $this.attr("minlength") + "' 个字符<!-- data-validation-minlength-message to override -->";
            ...
            if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
              message = "不正确的 Email 格式<!-- data-validation-email-message to override -->";
